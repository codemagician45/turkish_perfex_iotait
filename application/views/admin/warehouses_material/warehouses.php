			...
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						<div class="_buttons">
							<a href="#" class="btn btn-info pull-left" data-toggle="modal" data-target="#warehouse_modal"><?php echo _l('New Warehouse'); ?></a>
						</div>
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					...
					<span class="add-title"><?php echo _l('Add New Warehouse'); ?></span>
				</h4>
			</div>
	...
	$(function(){
		...
		$('#warehouse_modal').on('show.bs.modal', function(event) {
			...
			if (typeof(id) !== 'undefined') {
				...
				var warehouseName = $(button).parents('tr').find('td').eq(0).find('span.name').text();
