...
<div class="modal fade proposal-convert-modal" id="convert_to_estimate_new" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-xxl" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" onclick="close_modal_manually('#convert_to_estimate_new')" aria-label="Close">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php $this->load->view('admin/planing/new_work_order/estimate_template'); ?>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" onclick="close_modal_manually('#convert_to_estimate_new')">
                    <?php echo _l('close'); ?>
                </button>
...
<script>
    ...
    $('#convert_to_estimate_new #sale_agent').selectpicker('val',<?php echo $proposal->assigned; ?>);
    <?php } ?>
    ...
    $('#convert_to_estimate_new #clientid').change();
    // Trigger item select width fix
    $('#convert_to_estimate_new').on('shown.bs.modal', function(){
