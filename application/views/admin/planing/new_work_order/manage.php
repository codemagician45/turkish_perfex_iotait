...
<script>
   ...
   $(function(){
     ...
     initDataTable('.table-proposals', admin_url+'planning/table', ['undefined'], ['undefined'], Proposals_ServerParams, [0,'desc']);
     initDataTable('.table-proposals1', admin_url+'planning/table1', ['undefined'], ['undefined'], Proposals_ServerParams, [0,'desc']);
     init_proposal();
   });
</script>
</body>
