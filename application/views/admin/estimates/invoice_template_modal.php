      ...
      <div class="row">
        <div class="col-md-6">
              <?php 
                ...
                echo render_select('wo_phase_id',$work_order_phase,array('order_no','phase'),'work_order_phase',$selected,array('required' => true));
                 ?>
        </div>
      ...
      <div class="row">
        <div class="col-md-6">
            <?php 
              ...
              echo render_input('sum_volume',_l('sum_volume_m3'),$value,'text',array('readonly'=>true)); ?>
        </div>
