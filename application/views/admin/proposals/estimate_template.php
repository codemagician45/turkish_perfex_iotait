   ...
   <div class="panel-body">
      <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
              <?php if(!empty($proposal->pricing_category_id)) echo render_input('shipping_type',_l('shipping_type'),$proposal->shipping_type,'text',array('required' => true,'readonly' => true)); ?>
          </div>
        </div>
