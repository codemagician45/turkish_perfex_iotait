...
foreach ($rResult as $aRow) {
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        ...
        if ($aColumns[$i] == 'email_permission') {
            $checked = '';
            if ($aRow['email_permission'] == 1) {
                $checked = 'checked';
            }
            ...
            $_data = '<div class="onoffswitch">
                <input type="checkbox"' . ' data-switch-url="' . admin_url() . 'staff/change_staff_email_permission" name="onoffswitch" class="onoffswitch-checkbox" id="' . $aRow['staffid'] . '" data-id="' . $aRow['staffid'] . '" ' . ($aRow['email_permission'] == 1 ? 'checked' : '') . '>
